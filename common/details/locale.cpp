...
namespace common::platform_details
{
	...
	std::size_t wstring_convert::to_bytes(const wchar_t* wstr, std::size_t wlength, char* bstr, std::size_t blength)
	{
	...
	std::size_t wstring_convert::from_bytes(const char* bstr, std::size_t blength, wchar_t* wstr, std::size_t wlength)
	{
